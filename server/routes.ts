...
app.get("/api/admin/export-database", ensureAuthenticated, async (req, res) => {
  ...
  // Note: Admin webhook routes have been merged with the unified /api/webhooks endpoints
  // that are accessible through both admin authentication and API key authentication
  ...
  // Note: Admin webhook delivery history endpoint has been merged with the unified /api/webhooks endpoints
  // that are accessible through both admin authentication and API key authentication

  // Note: External endpoint for webhook deliveries has been merged with the unified /api/webhooks endpoints
  // that are accessible through both admin authentication and API key authentication
